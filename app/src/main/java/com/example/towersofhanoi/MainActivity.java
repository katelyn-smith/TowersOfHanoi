...
{
    private ViewGroup stagingArea; //represents area where popped disk waits for destination
    ...
    public void tower0ButtonPressed(View v) {
        ...
        if(this.tower0.getChildCount() > 1 || this.tower0.getChildCount() > 2)
        {
    ...
    public void tower1ButtonPressed(View v)
    {
        ...
        if(this.tower1.getChildCount() > 2)
        {
